...
bg=p.image.load('Class Stuff\images\\bgSmaller.jpg')
man=p.image.load('Class Stuff\images\Pygame-Tutorials-master\Game\standing.png')
...
p.display.set_caption("Jump Man")
jumpCount=7
COUNT=7
impact=False
while check:
